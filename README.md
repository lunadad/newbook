...
| 작업 | 주기 | 스크립트 |
|---|---|---|
| 오늘의 책 — 예스24·알라딘 | 화·금 15~19시, 5분 | `newbook_today_book_watch_http.sh` |
| 오늘의 책 — 교보문고 | 화·금 15~19시, 10분 | `newbook_today_book_watch_kyobo.sh` |
...
그래서 특정 시각을 겨냥한 좁은 크론 창 대신, 해당 시간대(양쪽 1시간 여유를 둔 15~19시)에
**짧은 주기 폴링 + 변경 게이트**를 쓴다. 그 밖의 시간은 4시간 안전망만으로 커버한다.
